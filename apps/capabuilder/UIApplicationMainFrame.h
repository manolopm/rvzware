...
#define SCENE_BUILDER 1022
#define LOAD_SCENE_BUILDER 1023
		...
		*/
		...
		class UIApplicationMainFrame : public wxFrame
		{
			public:
				...
				void InitGUIContents(cpw::LayerTree &layer_tree, cpw::remote::ConnectionManager *connection_manager,
				...
				void HideSplash(){load_splash->Show(false);};
				...
				void BuildScene(wxCommandEvent& WXUNUSED(event));
				void LoadBuildScene(wxCommandEvent& WXUNUSED(event));

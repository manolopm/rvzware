...
class Application :	public wxApp, public cpw::IApplication
{
	public:
		...
		void BuildScene();
		void LoadBuildScene();
		int Osgdem(std::vector<std::string> &options);
		cpw::Entity* GetWCS();
		//void Waiting();
	...
	private:
		...
		bool ProcessWMSURL(std::string &url, std::string &server, std::string &name, std::string &wmsversion, std::string &wmssrs, std::string &format, double &xmin, double &ymin, double &xmax, double &ymax);
		bool ProcessWCSURL(std::string &url, std::string &server, std::string &name, std::string &wmsversion, std::string &wmssrs, std::string &format, double &xmin, double &ymin, double &xmax, double &ymax, int &resx, int &resy);
		...
		std::string traslation_x_gizmo_id, traslation_y_gizmo_id, traslation_z_gizmo_id,
					...
					scale_x_gizmo_id, scale_y_gizmo_id, scale_z_gizmo_id;
		...
		cpw::ogcwcs::WcsLayerManager *wcs_request_manager;

	
		cpw::ICameraController *builder_camera_controller;
		WMSBoundingBoxController *bb_controller;

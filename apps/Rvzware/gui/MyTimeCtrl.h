...
namespace cpw { 
	...
	namespace gui
	{
		...
		/**
		 * \brief This custom time change event triggers whenever the value in the text
		 * control changes.
		 */
		...
		/**
		 *	\brief This control is the text part of the time-picker.
		 */
		...
		*/
		...
		public:
			...
			void SetFontType(const wxFont& font);
			/**

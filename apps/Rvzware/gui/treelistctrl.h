...
//AJ new checkbox_changed event
//--------------------------

/** 
	\brief 
*/
class CheckBoxChangeEvent : public wxNotifyEvent
{
public:

	CheckBoxChangeEvent();
	
	CheckBoxChangeEvent(wxEventType type, wxWindowID id = -1, const wxString& value = wxT("") );
	CheckBoxChangeEvent(const CheckBoxChangeEvent& event);
...
private:
	...
	DECLARE_DYNAMIC_CLASS(CheckBoxChangeEvent)
};

typedef void (wxEvtHandler::*MyCheckboxEventFunction) (CheckBoxChangeEvent&);

BEGIN_DECLARE_EVENT_TYPES()
	DECLARE_EVENT_TYPE(MyEVT_CHECKBOXCHANGE, 1)
END_DECLARE_EVENT_TYPES()

#define EVT_CHECKBOXCHANGE(id, func)  \
	DECLARE_EVENT_TABLE_ENTRY(MyEVT_CHECKBOXCHANGE, id, -1, (wxObjectEventFunction) (wxEventFunction) (MyCheckBoxEventFunction) & func, (wxObject *) NULL ),
//--------------------------
...
//extern const wxEventType CheckedItemTreeListCtrlEvent; 

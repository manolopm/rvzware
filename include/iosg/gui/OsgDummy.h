...
{ 
	namespace iosg 
	{
		...
		/** 
			...
			\ingroup iosg
		*/
		class IOSGEXPORT OsgIDummy : public OsgIWidget
		{
			public:	

				OsgIDummy(const std::string &url, cpw::Point3d<float> _position, cpw::Point3d<float> _size, cpw::Point3d<float> _rotation, const TAnchor &_anchor, const std::string &filename="");
				~OsgIDummy(void);
			...
			private:
				...
				cpw::Point3d<float> initial_size, initial_rotation;

...
std::ostream& operator <<(std::ostream& out, const wcsUrl& src)
{
   out << src.theUrl;
...
std::string wcsUrl::decode()const
{
   std::string tempS;
...
void wcsUrl::mergeUrl(const std::string& tempProtocol,
...
void wcsUrl::splitUrl(std::string& tempProtocol,
...
std::string wcsUrl::protocol()const
{
   std::string result;
...
std::string wcsUrl::server()const
{
...
std::string wcsUrl::options()const
{
   std::string result;
   std::string::size_type pos = theUrl.find("?");

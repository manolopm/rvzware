...
: wxToolBar(parent, id, pos, size, style, name), cpw::Observer(), parent_(parent), mult(1), multiplier(NULL), init(false), m_mgr(m_mgr_)
{
	...
	wxSpinButton *multiplier_spin = new wxSpinButton(this, ID_MULTIPLIER_SPIN, wxDefaultPosition, wxSize(10,19), wxSP_VERTICAL);
	AddControl(multiplier_spin);
	timeSlider = new wxSlider(this, ANIMATION_SLIDER, 0 , 0, 200, wxDefaultPosition, wxSize(150,19), wxSL_HORIZONTAL);
